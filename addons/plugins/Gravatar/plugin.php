...
class ETPlugin_Gravatar extends ETPlugin {
    ...
    public function init()
    {
        ...
        function avatar($member = array(), $className = '')
        {
            ...
            if (empty($member['email'])) {
                ...
                $email = md5(strtolower(trim($member['email'])));

                $url = $protocol.'://www.gravatar.com/avatar/'.$email.'?d='.$default.'&s=64';
            }
    ...
    /**
     * Construct and process the settings form for this skin, 
     * and return the path to the view that should be rendered.
     * 
