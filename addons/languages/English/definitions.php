...
$definitions["SQLite database"] = "SQLite database";
$definitions["SQLite queries"] = "SQLite queries";
$definitions["SQLite table prefix"] = "SQLite table prefix";
$definitions["SQLite version"] = "SQLite version";
...
$definitions["message.connectionError"] = "esoTalk could not connect to the SQLite server. The error returned was:<br/>%s";
...
$definitions["message.tablePrefixConflict"] = "The installer has detected that there is another installation of esoTalk in the same SQLite database with the same table prefix.<br>• To overwrite this installation, click 'Install' again. <strong>All data will be lost.</strong><br>• To create a new installation alongside this one, change the table prefix.";
