...
<label class='radio'><?php echo $form->radio("forumHeader", "both"); ?> <?php echo T("Show an image and the forum title in the header"); ?></label>
    <br/>
    <label class="forumHeaderImageLabel"><?php echo T("Image"); ?></label><br />
    <?php echo $form->input("forumHeaderImage", "file", array("class" => "text")); ?>
</div>
</li>
