...
$definitions["Back to members"] = "返回用户列表";
...
$definitions["Copy permissions from"] = "从这里复制用户权限设置";
...
$definitions["Groups can be used to categorize members and give them certain privileges."] = "用户组可以用来对不同用户进行分类。";
...
$definitions["Username or Email"] = "用户名 或 邮箱";
...
$definitions["message.fulltextKeywordWarning"] = "对不起，只能搜索英文内容。";
$definitions["message.gambitsHelp"] = "您可以利用[智能搜索]来寻找您想看的内容。双击可以立刻搜索。支持英文全文检索，但不支持中文关键词。";
...
$definitions["message.pageNotFound"] = "Sorry, the page you're looking for could not be found. [404]";
