...
ET::$languageInfo["Chinese"] = array(
	"locale" => "zh-CN",
	"name" => "Chinese",
	"description" => "A casual Chinese language pack.",
	"version" => ESOTALK_VERSION_ZHONGWEN,
	"author" => "esoTalk Team & iugo",
	"authorEmail" => "iugo@clian.net",
...
$definitions["%d week ago"] = "上星期";
$definitions["%d weeks ago"] = "%d 星期前";
$definitions["%d year ago"] = "去年";
$definitions["%d years ago"] = "%d 年前";

$definitions["%s and %s"] = "%s 和 %s";
$definitions["%s can view this conversation."] = "%s 可以浏览这个对话。";
...
$definitions["%s tagged you in a post."] = "%s 在帖子中提到了你。";
$definitions["%s will be able to view this conversation."] = "%s 将可以看到这个对话。";
$definitions["%s will be able to:"] = "%s 可以:";

$definitions["A new version of esoTalk (%s) is available."] = "A new version of esoTalk (%s) is available.";
$definitions["a private conversation"] = "私人对话";
...
$definitions["Automatically star conversations that I reply to"] = "Automatically star conversations that I reply to";
$definitions["Avatar"] = "Avatar";

$definitions["Back to channels"] = "返回频道页";
$definitions["Back to conversation"] = "返回帖子";
...
$definitions["Edit Group"] = "编辑组";
$definitions["Edit member groups"] = "编辑用户组";
$definitions["Edit your profile"] = "修改个人信息";
$definitions["Edit"] = "编辑";
...
$definitions["Email me when someone posts in a conversation I have starred"] = "Email me when someone posts in a conversation I have starred";
...
$definitions["gambit.starred"] = "starred";
